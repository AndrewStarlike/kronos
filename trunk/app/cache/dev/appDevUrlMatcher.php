...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/user')) {
            // kronos_index
            if (0 === strpos($pathinfo, '/user/index') && preg_match('#^/user/index(?:/(?P<inWeek>\\d+)(?:/(?P<inYear>\\d+))?)?$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'kronos_index')), array (  '_controller' => 'Kronos\\UserReportingBundle\\Controller\\UserController::indexAction',  'inWeek' => NULL,  'inYear' => NULL,));
            }

            // kronos_create_line
            if (0 === strpos($pathinfo, '/user/create-line') && preg_match('#^/user/create\\-line(?:/(?P<inWeek>\\d+)(?:/(?P<inYear>\\d+)(?:/(?P<type>[^/]++))?)?)?$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'kronos_create_line')), array (  '_controller' => 'Kronos\\UserReportingBundle\\Controller\\UserController::createLineAction',  'inWeek' => NULL,  'inYear' => NULL,  'type' => NULL,));
            }

            // kronos_edit_line
            if (0 === strpos($pathinfo, '/user/edit-line') && preg_match('#^/user/edit\\-line/(?P<lineId>\\d+)(?:/(?P<inWeek>\\d+)(?:/(?P<inYear>\\d+))?)?$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'kronos_edit_line')), array (  '_controller' => 'Kronos\\UserReportingBundle\\Controller\\UserController::editLineAction',  'inWeek' => NULL,  'inYear' => NULL,));
            }

            // kronos_delete_line_datas
            if (0 === strpos($pathinfo, '/user/delete-line-datas') && preg_match('#^/user/delete\\-line\\-datas/(?P<lineId>\\d+)(?:/(?P<inWeek>\\d+)(?:/(?P<inYear>\\d+))?)?$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'kronos_delete_line_datas')), array (  '_controller' => 'Kronos\\UserReportingBundle\\Controller\\UserController::deleteLineDatasAction',  'inWeek' => NULL,  'inYear' => NULL,));
            }

            // kronos_get_table
            if (0 === strpos($pathinfo, '/user/get-table') && preg_match('#^/user/get\\-table/(?P<lineTypeId>\\d+)(?:/(?P<inWeek>\\d+)(?:/(?P<inYear>\\d+))?)?$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'kronos_get_table')), array (  '_controller' => 'Kronos\\UserReportingBundle\\Controller\\UserController::getTableAction',  'inWeek' => NULL,  'inYear' => NULL,));
            }

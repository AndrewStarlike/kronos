...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/apps/kronos/trunk/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/apps/kronos/trunk/app/cache/dev/assetic/config'), true)));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'kronos', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_8fa7e8aff998eaa5a6b6cfdf4286c69ac94610f835e1d8998a404bcbcdb15265');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_8fa7e8aff998eaa5a6b6cfdf4286c69ac94610f835e1d8998a404bcbcdb15265');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_8fa7e8aff998eaa5a6b6cfdf4286c69ac94610f835e1d8998a404bcbcdb15265');
        ...
        $h->setProxyDir('C:/apps/kronos/trunk/app/cache/dev/doctrine/orm/Proxies');
    ...
    /**
     * Gets the 'kronos.date_tool' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Kronos\UserReportingBundle\Services\DateTool A Kronos\UserReportingBundle\Services\DateTool instance.
     */
    ...
    /**
     * Gets the 'kronos.dbal_tool' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Kronos\UserReportingBundle\Services\DbalTool A Kronos\UserReportingBundle\Services\DbalTool instance.
     */
    ...
    /**
     * Gets the 'kronos_core.admin.activity' service.
     *
     * @return Kronos\CoreBundle\Admin\ActivityAdmin A Kronos\CoreBundle\Admin\ActivityAdmin instance.
     */
    ...
    /**
     * Gets the 'kronos_core.admin.line_type' service.
     *
     * @return Kronos\CoreBundle\Admin\LineTypeAdmin A Kronos\CoreBundle\Admin\LineTypeAdmin instance.
     */
    ...
    /**
     * Gets the 'kronos_core.admin.project' service.
     *
     * @return Kronos\CoreBundle\Admin\ProjectAdmin A Kronos\CoreBundle\Admin\ProjectAdmin instance.
     */
    ...
    /**
     * Gets the 'kronos_core.admin.task_type' service.
     *
     * @return Kronos\CoreBundle\Admin\TaskTypeAdmin A Kronos\CoreBundle\Admin\TaskTypeAdmin instance.
     */
    ...
    /**
     * Gets the 'kronos_core.admin.team' service.
     *
     * @return Kronos\CoreBundle\Admin\TeamAdmin A Kronos\CoreBundle\Admin\TeamAdmin instance.
     */
    ...
    /**
     * Gets the 'kronos_user.admin.user' service.
     *
     * @return Kronos\UserBundle\Admin\UserAdmin A Kronos\UserBundle\Admin\UserAdmin instance.
     */
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/apps/kronos/trunk/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/apps/kronos/trunk/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/apps/kronos/trunk/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/apps/kronos/trunk/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/apps/kronos/trunk/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/apps/kronos/trunk/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/apps/kronos/trunk/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'C:/apps/kronos/trunk/app/cache/dev/translations', 'debug' => true));
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/apps/kronos/trunk/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\apps\\kronos\\trunk\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\apps\\kronos\\trunk\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/apps/kronos/trunk/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/apps/kronos/trunk/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/apps/kronos/trunk/app/cache/dev');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/apps/kronos/trunk/app/cache/dev',
            ...
            'debug.container.dump' => 'C:/apps/kronos/trunk/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/apps/kronos/trunk/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:C:/apps/kronos/trunk/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/apps/kronos/trunk/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/apps/kronos/trunk/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/apps/kronos/trunk/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/apps/kronos/trunk/app/cache/dev/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'C:/apps/kronos/trunk/app/cache/dev/doctrine/orm/Proxies',
